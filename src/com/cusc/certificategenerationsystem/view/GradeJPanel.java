...
public class GradeJPanel extends javax.swing.JPanel {
    ...
    public GradeJPanel()  {
        ...
        DatabaseProcess.loadData("SELECT * FROM Grades", tblGrade);
        lbNotification.setVisible(false);
        txtGradeID.setText(DatabaseProcess.getID("execute sp_Grade_identityID"));
    }
    ...
    int row;
    if(gradeName.matches(".{1,20}") == false){
        JOptionPane.showMessageDialog(null, "Grade Name must be between 1 and 15 characters!", "Message",1);
        txtGradeName.requestFocus();
    }else if(numMax<0 && numMax>100){
        JOptionPane.showMessageDialog(null, "Max must be an integer, Max from 0 to 100", "Message", 1);
        txtMax.requestFocus();
    }else if(numMin<0 && numMin>100){
        JOptionPane.showMessageDialog(null, "Min must be an integer, Min from 0 to 100", "Message", 1);
        txtMin.requestFocus();
    }else{
        switch(func){
            case 1:
                String sql1 = "INSERT INTO Grades VALUES('"+gradeID+"','"+gradeName+"','"+numMax+"','"+numMin+"')";
            ...
            case 2:
                ...
                break;
            case 3:
                String sql3 = "DELETE FROM Grades WHERE GradeID='"+gradeID+"'";
    ...
    private void notifySuccessful(){
        ...
        DatabaseProcess.tableModel = (DefaultTableModel)tblGrade.getModel();
    ...
    private void initComponents() {
        ...
        tblGrade.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        tblGrade.setRowHeight(20);
        tblGrade.setRowMargin(5);
        tblGrade.setSelectionBackground(new java.awt.Color(71, 120, 197));
        ...
        pnlDetails.add(scrGrade, java.awt.BorderLayout.CENTER);

        pnlInfo.setBackground(new java.awt.Color(255, 255, 255));
        pnlInfo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Grade Information", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 15))); // NOI18N

        txtGradeName.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        txtGradeName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtGradeNameKeyPressed(evt);
            }
        });
        ...
        txtGradeID.setDisabledTextColor(new java.awt.Color(0, 0, 0));

        lbGradeID.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lbGradeID.setText("GradeID:");

        lbMax.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lbMax.setText("Max:");

        lbMin.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lbMin.setText("Min:");

        txtMax.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N

        txtMin.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        pnlInfoLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlInfoLayout.createSequentialGroup()
                ...
                .addGap(70, 70, 70)
                .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbMin, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lbMax, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(40, 40, 40)
                .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtMax)
                    .addComponent(txtMin))
            ...
            .addGroup(pnlInfoLayout.createSequentialGroup()
                .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlInfoLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbMax, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtMax, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbMin, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtMin, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(pnlInfoLayout.createSequentialGroup()
                        .addGap(28, 28, 28)
                        .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbGradeID, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        pnlInfoLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtGradeName, txtMax, txtMin});
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 1139, Short.MAX_VALUE)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnlInfo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(pnlDetails, javax.swing.GroupLayout.DEFAULT_SIZE, 949, Short.MAX_VALUE))
                .addGap(10, 10, 10)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(pnlDetails, javax.swing.GroupLayout.DEFAULT_SIZE, 452, Short.MAX_VALUE)
                        .addGap(10, 10, 10))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(pnlManage, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void pnlAddMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlAddMousePressed
        try{
            ...
            JOptionPane.showMessageDialog(null, "Max and Min must be an integer, Max and min  from 0 to 100", "Message", 1);
        }
        
    }//GEN-LAST:event_pnlAddMousePressed

    private void txtGradeNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtGradeNameKeyPressed
        lbNotification.setVisible(false);
    }//GEN-LAST:event_txtGradeNameKeyPressed
    ...
    private void tblGradeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGradeMouseClicked
        try {
            ...
            String idRow = (tblGrade.getModel().getValueAt(row, 0).toString());
            String sql = "SELECT * FROM Grades WHERE GradeID='"+idRow+"'";
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        DatabaseProcess.loadData("SELECT * FROM Grades WHERE GradeID like '%"+search+"%' "
                + "OR GradeName like '%"+search+"%'" , tblGrade);
